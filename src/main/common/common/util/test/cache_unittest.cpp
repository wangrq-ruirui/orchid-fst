...
void CacheTest::testLRUCache() {
    ...
    LRUCache<string,uint32_t,GetStringSize,GetUInt32Size,KeyHash<string>, KeyEqual<string> > lruCache(initialHashSize,totalMemSize);
    LFUCache<string,uint32_t,GetStringSize,GetUInt32Size,KeyHash<string>, KeyEqual<string> > lfuCache(initialHashSize,totalMemSize);

    unordered_map<string,uint32_t,KeyHash<string>, KeyEqual<string> > m(initialHashSize);
